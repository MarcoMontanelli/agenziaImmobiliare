...
--
-- Host: 127.0.0.1
-- Creato il: Apr 15, 2024 alle 13:29
...
(20, 'gsdfagfsgsf', 'gfssfggfssgfg', '3443343425', 'marco.montanelli05@gmail.comlp', NULL, '$2y$10$FXRLZy0O69i5XcbcJo3XsOQXxYRb8TocTusaKUKkjwdTaglA.6GWK', 1);
...
CREATE TABLE `preferiti` (
  ...
  `idAnnuncioIr` int(11) DEFAULT NULL,
  `dataAggiunto` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `preferiti` (`idPreferito`, `idCliente`, `idAnnuncioIr`, `dataAggiunto`) VALUES
(2, 18, 22, '2024-04-10 17:43:43'),
(3, 18, 22, '2024-04-10 17:59:56');
...
ALTER TABLE `preferiti`
  ...
  ADD KEY `idAnnuncioIr` (`idAnnuncioIr`);
...
--
ALTER TABLE `preferiti`
  MODIFY `idPreferito` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `preferiti`
  ADD CONSTRAINT `preferiti_ibfk_1` FOREIGN KEY (`idCliente`) REFERENCES `cliente` (`idCliente`),
  ADD CONSTRAINT `preferiti_ibfk_2` FOREIGN KEY (`idAnnuncioIr`) REFERENCES `annuncioir` (`idAnnuncioIr`);
