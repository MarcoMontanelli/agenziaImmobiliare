...
--
-- Host: 127.0.0.1
-- Creato il: Apr 03, 2024 alle 23:08
...
(23, 'prova due', 'casa spaziosa', 'Villa bifamiliare con due appartamenti libera subito, la proprietà comprende balconi per dimensioni complessive di 80mq, un giardino con piscina di dimensioni 900mq e un garage da 4 posti', '3456789876', '2024-03-25 16:04:59', '2024-03-25 16:04:59'),
...
(15, 'mirkolino', 'marco227', '1234567890', 'mirko@gmail.com', NULL, '$2y$10$3Cs4Pxdv6iqzQNWxAdHwrO2H26IK9sTgMfVvYjzR15Z4/S6iR04nC', 1);
...
--
-- Dump dei dati per la tabella `immaginiannuncio`
--
...
(44, 'uploads/casa3.jpg', 23),
(45, 'uploads/NEGOZIO.webp', 23),
(46, 'uploads/TERRENO.webp', 23),
...
('123456789', 'Villa Bifamiliare', 'Bergamo', 'via reich 68 d', 4, 2, 2000000, 380, 4, 2001, 3, 'A', 1, 1, 1, 1, 1, 1, 1, 1, 45.716637634317884, 9.704443215887297),
('3456789876', 'Villa Bifamiliare', 'Bergamo', 'via campinette 32', 2, 3, 500000, 220, 2, 2024, 2, 'A', 1, 0, 0, 1, 0, 1, 1, 1, 51.503720644747645, -0.0982475350610912),
('545454332222', 'Villa Singola', 'Bergamo', 'Via corridoni 32', 3, 3, 700000, 500, 4, 2001, 2, 'D', 1, 1, 1, 1, 1, 1, 1, 1, 45.705974493158735, 9.6869730927574);
...
--
ALTER TABLE `agenzia_immobiliare`
  MODIFY `idAgenzia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `annuncioir`
  MODIFY `idAnnuncioIr` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
