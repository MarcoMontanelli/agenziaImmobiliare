...
<div class="main">
    ...
    <button onclick="location.href='removeAnnuncio.php'">rimuovi annuncio</button>
    <button onclick="location.href='removeProp.php'">rimuovi proprietario</button>
    <button onclick="location.href='removeProprieta.php'">rimuovi proprietà</button>
    <button onclick="location.href='removeAdmin.php'">rimuovi admin</button>
    <button onclick="location.href='removeCliente.php'">rimuovi clienti</button>
    <button onclick="location.href='removeAgenzia.php'">rimuovi agenzie</button>
</div>
