...
<body class="bg-black">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 md:p-8 lg:p-12 space-y-4 md:space-y-6 max-w-md mx-auto">
        ...
        <a href="register.php"
            ...
            Agenzia</a>
            <a href="aggiungiAnnuncio.php"
            class="flex items-center justify-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Aggiungi Annuncio</a>
