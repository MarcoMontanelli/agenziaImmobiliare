  ...
  <div class="min-h-screen flex flex-col">
    ...
    <div class="px-4 md:px-8 lg:px-16 xl:px-24">
      <?php foreach ($results as $row): ?>
        <div
          class="mt-16 max-w-full border-white bg-gradient-to-tl from-slate-900 via-gray-800 to-slate-600 shadow-3xl rounded-lg overflow-hidden flex flex-col md:flex-row">
          <!-- Image -->
          <div
            class="md:w-1/3 flex items-center justify-center bg-gradient-to-tl from-slate-900 via-gray-800 to-slate-600">
            <?php
            $images = explode(',', $row['immagini']);
            $firstImage = !empty ($images[0]) ? htmlspecialchars($images[0]) : 'path/to/default/image.png';
            ?>
            <!-- Image Style Adjusted -->
            <img class="object-cover object-center w-full h-full md:h-auto" src="<?php echo $firstImage; ?>"
              alt="Property" style="max-height: 100%;">
          </div>
          ...
          <div class="p-4 flex flex-col justify-between flex-grow">
            ...
            <div class="flex justify-between items-center mt-4">
              <button class="bg-blue-500 hover:bg-blue-700 text-white text-2xl font-bold py-3 px-6 rounded">
                MESSAGGIO
              </button>
              <button class="bg-blue-500 hover:bg-blue-700 text-white text-2xl font-bold py-3 px-6 rounded">
                VISITA
              </button>
              <button class="text-white hover:text-gray-600 text-2xl">
                <i class="far fa-heart"></i>
              </button>
            </div>
          </div> <!-- Content End -->
          <div class="mt-4 mb-4 mr-4 w-full md:w-1/4 p-4 bg-gray-600 rounded-lg">
            <div class="bg-gray-700 text-white rounded-lg overflow-hidden mb-6">
              <div class="flex items-center justify-between p-4">
                <!-- Placeholder for Calendar, this will be replaced by JavaScript -->
                <div class="calendar" id="calendar<?php echo $row['idAnnuncioIr']; ?>"></div>
              </div>
            </div>
