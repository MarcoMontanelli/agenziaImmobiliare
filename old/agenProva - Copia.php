...
<head>
    ...
    background-color: #9a4ef2; /* Colore di sfondo più scuro */
    margin: 0;
    padding: 0;
    display: flex;
    align-items: center;
...
form {
    background-color: #b57fff; /* Colore di sfondo più chiaro */
    padding: 20px;
    border-radius: 8px;
...
h2 {
    text-align: center;
    color: #ffffff; /* Testo principale o colore di sfondo chiara */
}

label {
    display: block;
    margin-bottom: 8px;
    color: #4a148c; /* Tono più scuro per il testo */
}
...
input[type="submit"] {
    background-color: #8f00ff; /* Colore principale (Blu/Viola) */
    color: #ffffff; /* Testo principale o colore di sfondo chiara */
    cursor: pointer;
}

input[type="submit"]:hover {
    background-color: #4a148c; /* Tono più scuro per l'hover */
}
...
.image-preview {
    ...
    height: auto;
    margin-bottom: 15px;
    display: block; /* Imposta la visualizzazione su "block" per visualizzare correttamente più immagini */
}
    </style>
    <script>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        // Ottiene l'ID dell'annuncio appena inserito
