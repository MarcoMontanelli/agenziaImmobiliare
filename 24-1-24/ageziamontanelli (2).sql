...
--
-- Host: 127.0.0.1
-- Creato il: Gen 24, 2024 alle 21:31
...
--
ALTER TABLE `agenziaprovvisoria`
  MODIFY `idAgenziap` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `annuncio`
  MODIFY `idAnnuncio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
...
--
ALTER TABLE `proprietario`
  MODIFY `codiceFiscale` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
