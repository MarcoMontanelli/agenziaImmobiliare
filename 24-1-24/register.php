...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO agenziaprovvisoria (nome, partitaIva, indirizzo, numeroTelefono, email, nomeProprietario, località, pass) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
    ...
    if ($stmt->execute()) {
        ...
        $stmtVerification = $conn->prepare("INSERT INTO verificaAg (id_agenziap, codiceVerifica, scadenza) VALUES (?, ?, NOW() + INTERVAL 20 SECOND)");
