...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO agenzia_immobiliare (nome, partitaIva, indirizzo, numeroTelefono, email, nomeProprietario, località, pass, verificato) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("sssssssss", $nome, $partitaIva, $indirizzo, $numeroTelefono, $email, $nomeProprietario, $localita, $password, $verificato);
    ...
    <div class="container max-w-md mx-auto bg-gray-800 rounded-lg shadow dark:bg-gray-800 p-8">
        <form action="" method="post" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" id="nome" name="nome" class="bg-gray-700 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600" required>
            </div>

            <div>
                <label for="partitaIva" class="block text-sm font-medium text-gray-900 dark:text-white">Partita IVA:</label>
                <input type="text" id="partitaIva" name="partitaIva" class="bg-gray-700 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600">
            </div>
            <div>
                <label for="indirizzo" class="block text-sm font-medium text-gray-900 dark:text-white">Indirizzo:</label>
                <input type="text" id="indirizzo" name="indirizzo" class="bg-gray-700 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600">
            </div>
            <div>
                <label for="numeroTelefono" class="block text-sm font-medium text-gray-900 dark:text-white">Numero di Telefono:</label>
                <input type="text" id="numeroTelefono" name="numeroTelefono" class="bg-gray-700 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600" required>
            </div>
            <div>
                <label for="email" class="block text-sm font-medium text-gray-900 dark:text-white">Email:</label>
                <input type="email" id="email" name="email" class="bg-gray-700 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600" required>
            </div>
            <div>
                <label for="nomeProprietario" class="block text-sm font-medium text-gray-900 dark:text-white">Nome Proprietario:</label>
                <input type="text" id="nomeProprietario" name="nomeProprietario" class="bg-gray-700 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600">
            </div>
            <div>
                <label for="localita" class="block text-sm font-medium text-gray-900 dark:text-white">Località:</label>
                <input type="text" id="localita" name="localita" class="bg-gray-700 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600">
            </div>
            <div>
                <label for="pass" class="block text-sm font-medium text-gray-900 dark:text-white">Password:</label>
                <input type="password" id="pass" name="pass" class="bg-gray-700 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600" required>
            </div>
            <!--
            <div>
            ...
            -->
            <div>
                <input type="submit" value="Registrati" class="w-full text-white bg-blue-400 hover:bg-blue-200 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center cursor-pointer ">
            </div>
            <p class="text-sm text-gray-500 dark:text-gray-400">sei già registrato? <a href="login.php" class="text-primary-600 hover:underline dark:text-primary-500">accedi</a></p>
        </form>
    </div>
    </section>
