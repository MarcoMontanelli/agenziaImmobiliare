  ...
  <div class="p-4">
    <div class="flex justify-center">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-6xl">
        <!-- Card 1 -->
        <div class="rounded-lg overflow-hidden shadow-lg bg-blue-900">
          <img class="w-full" src="TERRENO.webp" alt="Image description">
          <div class="px-6 py-4">
            <div class="font-bold text-xl mb-2">Terreno</div>
        ...
        <div class="max-w-sm rounded-lg overflow-hidden shadow-lg bg-blue-900">
      <img class="w-full" src="AUTORIMESSA.webp" alt="Image description">
      <div class="px-6 py-4">
        <div class="font-bold text-xl mb-2">Autorimessa</div>
        <p class="text-gray-700 text-base">
          vendi un'autorimessa
        </p>
      </div>
      <div class="px-6 pt-4 pb-2">
        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
    ...
    <div class="max-w-sm rounded-lg overflow-hidden shadow-lg bg-blue-900">
      <img class="w-full" src="IMMOBILE INDUSTRIALE.webp" alt="Image description">
      <div class="px-6 py-4">
        <div class="font-bold text-xl mb-2">Immobile industriale</div>
        <p class="text-gray-700 text-base">
          vendi un immobile industriale
        </p>
      </div>
      <div class="px-6 pt-4 pb-2">
        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
    ...
    <div class="max-w-sm rounded-lg overflow-hidden shadow-lg bg-blue-900">
      <img class="w-full" src="UFFICIO.webp" alt="Image description">
      <div class="px-6 py-4">
        <div class="font-bold text-xl mb-2">Ufficio</div>
        <p class="text-gray-700 text-base">
          vendi un Ufficio
        </p>
      </div>
    ...
    <div class="max-w-sm rounded-lg overflow-hidden shadow-lg bg-blue-900">
      <img class="w-full" src="MAGAZZINO.webp" alt="Image description">
      <div class="px-6 py-4">
        <div class="font-bold text-xl mb-2">Magazzino</div>
        <p class="text-gray-700 text-base">
          vendi un Magazzino
        </p>
      </div>
    ...
    <div class="max-w-sm rounded-lg overflow-hidden shadow-lg bg-blue-900">
      <img class="w-full" src="NEGOZIO.webp" alt="Image description">
      <div class="px-6 py-4">
        <div class="font-bold text-xl mb-2">Negozio</div>
        <p class="text-gray-700 text-base">
          vendi un negozio
        </p>
      </div>
      <div class="px-6 pt-4 pb-2">
        ...
        <!-- Repeat the card structure for the remaining 5 cards -->
      </div>
    </div>
  </div>
</section>
