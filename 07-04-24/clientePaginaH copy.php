...
<head>
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/flowbite@latest/dist/flowbite.min.css" />
  ...
  <style>
    ...
    .md:flex-row {
      ...
      /* or use Tailwind class md:items-start */
    }

    .swiper-container {
      min-height: 0; // Resets any previous minimum height
    }
  </style>
</head>
...
<body class="bg-[#1a1a3e]">
  ...
  <div class="min-h-screen flex flex-col">
    ...
    <div class="px-4 md:px-8 lg:px-16 xl:px-24">
      <?php foreach ($results as $row): ?>
        <!-- Card Container -->
        <div
          class="mt-16 max-w-full mx-auto bg-gradient-to-tl from-slate-900 via-gray-800 to-slate-600 shadow-3xl rounded-lg overflow-hidden md:flex md:flex-row md:items-start">

          <div class="md:flex md:flex-col md:w-1/3">
            <div class="p-4 m-4 bg-gray-700 rounded-lg overflow-hidden">
              <div class="swiper-container" style="margin-left: auto; margin-right: auto;">
                <div class="swiper-container" style="margin-left: auto; margin-right: auto;">
                  <div class="swiper-wrapper">
                    <?php
                    $images = explode(',', $row['immagini']);
                    $mainImage = $images[0]; // Assuming the first image is the main image for the slider
                    echo '<div class="swiper-slide"><img src="' . htmlspecialchars($mainImage) . '" alt="Main Image" class="object-cover w-full" style="aspect-ratio: 16 / 9;"></div>';
                    ?>
                  </div>
                  <!-- Add Pagination -->
            ...
            <div class="hidden md:grid md:grid-cols-2 md:gap-4">
              <?php
              $galleryImages = array_slice($images, 1, 2); // Limit to two images
              foreach ($galleryImages as $galleryImage) {
                echo '<div class="gallery-image" style="padding: 0; margin: 0;"><img src="' . htmlspecialchars($galleryImage) . '" alt="Gallery Image" class="object-cover w-full h-full rounded-lg"></div>';
              }
              ?>
            </div>
          </div>
          ...
          <div class="p-4 flex flex-col justify-between flex-grow md:w-2/3 bg-gray-800 rounded-lg">
            ...
            <div>
              ...
              <div class="flex justify-between items-start">
                <div>
                  ...
                  <div class="text-blue-300 font-bold text-5xl mb-2">€
                    <?php echo htmlspecialchars($row['prezzo']); ?>
                  </div>
                </div>
                <img class="h-24 w-24 rounded-full" src="logo 256 256.png" alt="Company Logo">
              </div>
              <hr class="mb-4">

              <!-- Property details with icons -->
              <div class="grid grid-cols-2 gap-4 text-gray-200 my-4">
                <?php
              ...
              <!-- Description -->
              <p class="mb-4 text-gray-200 text-xl md:text-2xl">
            ...
            <div class="relative z-10">
              <div class="mt-2" id="map<?php echo $row['idAnnuncioIr']; ?>" style="height: 200px;"></div>
            </div>
            ...
            <div class="flex flex-col md:flex-row justify-between mt-4">
              ...
              <!-- Visita Button - Triggers Popover -->
              <button data-popover-target="popover-calendar<?php echo $row['idAnnuncioIr']; ?>" type="button"
                class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-2 md:mb-0 md:mr-2">
                Visita
              </button>
              <!-- Heart Icon -->
            ...
            <!-- Calendar Popover -->
            <!-- Keep your existing PHP code here for calendar popover -->
          </div>

          <!-- Gallery below swiper for mobile view -->
          <div class="md:hidden grid grid-cols-2 gap-2 p-2">
            <?php
            // Display the first two images for the mobile gallery
            $galleryImages = array_slice($images, 1, 2); // Starts from the second image
            foreach ($galleryImages as $galleryImage) {
              echo '<img src="' . htmlspecialchars($galleryImage) . '" alt="Gallery Image" class="object-cover object-center w-full h-32 rounded-lg">';
            }
            ?>
          </div>
  ...
  <script>
    var swiper = new Swiper('.swiper-container', {
      ...
      // Ensure navigation buttons do not add height
      navigation: {
        nextEl: '.swiper-button-next',
        prevEl: '.swiper-button-prev',
      },
